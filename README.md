...
1. 因为我以前的图形化编程基础，因此函数上手也比较熟悉，[part3代码地址](https://github.com/backway-Lai/GLIMMER-CS-EASY-01/blob/main/part3.c)[^3]
2. 关于原题代码，结果如下：
![1](https://github.com/backway-Lai/GLIMMER-CS-EASY-01/raw/main/images/screen-shot8.png)
其中因为a,b只在`swap`函数中发生了值的改变，并没有影响到外部实参的值，因此打印结果不变。
***
